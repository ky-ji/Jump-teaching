    ...
    def _forward_impl(self, x: Tensor, weights=None, get_feat = False) -> Tensor:
        if weights == None:
            if(self.hashbits<0):
                ...
                output_s = self.fc(out)
                output_h = self.hash_layer(out)
                return output_s,output_h
...
def resnet18SH(
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnetSH('resnet18SH', BasicBlock, [2, 2, 2, 2],  pretrained,progress,
                input_channel=input_channel, num_classes=num_classes,hashbits=hashbits, **kwargs)
...
def resnet34SH(
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnetSH('resnet34H', BasicBlock, [3, 4, 6, 3],  pretrained,progress,
                    input_channel=input_channel, num_classes=num_classes, hashbits = hashbits,**kwargs)
...
def resnet50SH(
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnetSH('resnet50H', Bottleneck, [3, 4, 6, 3], pretrained, progress,
                    input_channel=input_channel, num_classes=num_classes,hashbits =hashbits, **kwargs)
